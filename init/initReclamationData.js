...
async function initializeReclamationData() {
    try {
        ...
        const [rows] = await db.promise().query('SELECT COUNT(*) as count FROM Reclamation');
        ...
        if (count === 0) {
            ...
            const insertQuery = `
                ...
                (16, 3, NULL, 'panne urgente', '2024-12-20 23:33:16', 'TECHNIQUE', 'En instance', NULL, '/uploads/reclamations/1734733996246-OIP.jpg', 'MOYEN', 48, NULL, 'NEUTRE', 'MOYENNE', 0, NULL, NULL, NULL, NULL, NULL),
