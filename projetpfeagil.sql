...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 17 jan. 2025 à 14:28
...
CREATE TABLE `livraison` (
  `idLivraison` bigint(20) NOT NULL,
...
CREATE TABLE `maintenanceanalytics` (
  `id` int(11) NOT NULL,
  `equipment_id` int(11) DEFAULT NULL,
  ...
  `estimated_costs` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`estimated_costs`)),
...
CREATE TABLE `reclamation` (
  `idReclamation` bigint(20) NOT NULL,
  ...
  `aiConfidence` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`aiConfidence`)),
  `image_analysis` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`image_analysis`)),
...
INSERT INTO `reclamation` (`idReclamation`, `idGerant`, `idCommercial`, `description`, `date`, `type`, `etat`, `material`, `image_url`, `priority`, `estimatedResolutionTime`, `actualResolutionTime`, `satisfaction`, `gravite`, `sentiment_score`, `suggestedActions`, `aiConfidence`, `image_analysis`, `reponse`, `date_reponse`) VALUES
...
ALTER TABLE `commande`
  ...
  ADD UNIQUE KEY `RefCommande` (`RefCommande`),
...
--
-- Index pour la table `equipmentsensors`
--
ALTER TABLE `equipmentsensors`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `gerant`
  ...
  ADD UNIQUE KEY `numGerant` (`numGerant`),
...
--
-- Index pour la table `maintenanceanalytics`
--
ALTER TABLE `maintenanceanalytics`
  ADD PRIMARY KEY (`id`),
  ADD KEY `equipment_id` (`equipment_id`);
...
ALTER TABLE `reclamation`
  ...
  ADD KEY `idGerant` (`idGerant`),
  ADD KEY `idCommercial` (`idCommercial`);

--
-- Index pour la table `stationservice`
--
...
--
ALTER TABLE `commande`
  MODIFY `idCommande` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `depot`
  MODIFY `idDepot` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `equipmentsensors`
--
ALTER TABLE `equipmentsensors`
...
--
ALTER TABLE `livraison`
  MODIFY `idLivraison` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT pour la table `maintenanceanalytics`
--
ALTER TABLE `maintenanceanalytics`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `reclamation`
  MODIFY `idReclamation` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT pour la table `stationservice`
--
ALTER TABLE `stationservice`
  MODIFY `idStation` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `utilisateur`
--
ALTER TABLE `utilisateur`
  MODIFY `identifiant` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
COMMIT;
