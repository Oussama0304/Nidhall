...
import ReclamationAnalytics from './pages/ReclamationAnalytics';
  ...
  switch (role) {
    ...
    case 'COMMERCIAL':
      return [
        ...
        { text: 'Stations', icon: <LocationOnIcon />, path: '/stations' },
        { text: 'Analytique des réclamations', icon: <ReportIcon />, path: '/analytics' },
      ];
    case 'DEPOT':
      return [
        ...baseItems,
              ...
              <Routes>
                ...
                {userRole === 'COMMERCIAL' && (
                  <>
                    ...
                    <Route path="/analytics" element={<ReclamationAnalytics />} />
                  </>
                )}
                {userRole === 'DEPOT' && (
                  <>
