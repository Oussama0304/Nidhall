...
const Dashboard = () => {
  ...
  const handleImageChange = async (event) => {
    ...
    if (file) {
      setReclamationFormData(prev => ({ ...prev, image: file }));
  ...
  const handleReclamationSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.imageAnalysis) {
        ...
        // Mettre à jour le type de réclamation en fonction de l'analyse
        if (response.data.imageAnalysis.recommendedType) {
          setReclamationFormData(prev => ({
            ...prev,
            type: response.data.imageAnalysis.recommendedType
          }));
        }
      }
        ...
        <DialogContent>
          <FormControl fullWidth sx={{ mb: 2 }}>
            ...
            <Select
              ...
              onChange={(e) => setReclamationFormData(prev => ({ ...prev, type: e.target.value }))}
            >
          ...
          <TextField
            ...
            onChange={(e) => setReclamationFormData(prev => ({ ...prev, description: e.target.value }))}
            sx={{ mb: 2 }}
          />
          ...
          <TextField
            ...
            onChange={(e) => setReclamationFormData(prev => ({ ...prev, idGerant: e.target.value }))}
            required
          />
          ...
          {imageAnalysis && <ImageAnalysisResult analysis={imageAnalysis} />}
        </DialogContent>
        <DialogActions>
